...
#### Usage
 ...
 Plotnine code was written within a virtual python environment utilizing the `reticulate` package. 
 The main plotnine code resides within: `/R/plotnine.py`
 
 There are helper functions that assist in plotnine generation, so this script should be run beforehand. to load the environment. The actual plotnine plots are located in `/R/plots.py`. 
