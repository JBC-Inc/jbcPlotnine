...
# Shiny app:
#
#   reactive - rate/cum, quality report, regular/log scale
#
#   has nice styling without quality report
#
#   lose some styling aesthetics when quality report is added
# 
# When quality report is added, must render image, 
#
# otherwise we can render plotnine
#
# OR - render 2 plotnine outputs close together........ YES 
#
# This way we can keep both plots and styling
#
# Also, look for a way to add the second axis plot to patchworklib with negative margins
