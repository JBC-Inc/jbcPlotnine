...
# plt.gca()
#==============================================================================
# if there is no axes on this figure (but we havent created a figure yet)
...
#
# to test whether there is currently an Figure on the pyplot figure stack, 
# check whether .pyplot.get_fignums() is empty
# 
...
# 
#   create and manage figures and plots using matplotlib. 
#   The state-based interface provided by plt is convenient for quick and simple plotting, 
#   while the object-oriented interface (direct manipulation of Figure and Axes objects) 
